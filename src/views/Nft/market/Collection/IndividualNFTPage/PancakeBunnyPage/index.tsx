...
import { PANBERRIES_BUNNIES_UPDATE_FREQUENCY } from 'config'
...
const IndividualPancakeBunnyPage: React.FC<IndividualPancakeBunnyPageProps> = ({ bunnyId }) => {
  ...
  useEffect(() => {
    ...
    if (msSinceLastUpdate > PANBERRIES_BUNNIES_UPDATE_FREQUENCY && !isUpdatingPancakeBunnies && isWindowVisible) {
